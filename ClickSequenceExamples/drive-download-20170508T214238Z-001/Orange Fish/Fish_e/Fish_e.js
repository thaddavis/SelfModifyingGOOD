...
// stage content:
(lib.Fish_e = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_4 = function() {
		this.fourteen14.addEventListener("click", fl_ClickToGoToAndStopAtFrame_25.bind(this));
	...
	this.twenty20.setTransform(249.1,107.1);
	...
	this.nineteen19.setTransform(472.5,129.6);
	...
	this.eighteen18.setTransform(541.5,208.6);
	...
	this.seventeen17.setTransform(350.5,277.6);
	...
	this.sixteen16.setTransform(497.5,360.6);
	...
	this.fifteen15.setTransform(379.5,437.1);
	...
	this.fourteen14.setTransform(255.1,413.5);
	...
	this.thirteen13.setTransform(138.1,388.6);
	...
	this.twelve12.setTransform(172.1,270.6);
	new cjs.ButtonHelper(this.twelve12, 0, 1, 2, false, new lib.twelve12(), 3);

	this.eleven11 = new lib.eleven11();
	this.eleven11.parent = this;
	this.eleven11.setTransform(271.6,276.6);
	new cjs.ButtonHelper(this.eleven11, 0, 1, 2, false, new lib.eleven11(), 3);

	this.ten10 = new lib.ten10();
	this.ten10.parent = this;
	this.ten10.setTransform(122.6,159.6);
	new cjs.ButtonHelper(this.ten10, 0, 1, 2, false, new lib.ten10(), 3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.ten10},{t:this.eleven11},{t:this.twelve12},{t:this.thirteen13},{t:this.fourteen14},{t:this.fifteen15},{t:this.sixteen16},{t:this.seventeen17},{t:this.eighteen18},{t:this.nineteen19},{t:this.twenty20}]}).to({state:[]},12).wait(103));

	// Numbers
	this.eleven11_1 = new lib.eleven11();
	this.eleven11_1.parent = this;
	this.eleven11_1.setTransform(271.6,276.6);
	...
	this.twelve12_1.setTransform(172.1,270.6);
	...
	this.thirteen13_1.setTransform(138.1,388.6);
	...
	this.fourteen14_1.setTransform(255.1,413.5);
	...
	this.fifteen15_1.setTransform(379.5,437.1);
	...
	this.sixteen16_1.setTransform(497.5,360.6);
	...
	this.seventeen17_1.setTransform(350.5,277.6);
	...
	this.eighteen18_1.setTransform(541.5,208.6);
	...
	this.nineteen19_1.setTransform(472.5,129.6);
	...
	this.twenty20_1.setTransform(249.1,107.1);
	...
	// Fish
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1.5,1,1).p("AnRl/QG/G9HkFC");
	this.shape.setTransform(187.8,230.3);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#000000").ss(1.5,1,1).p("AHLDmIlXknIHlB+QgQASgQASQgyA6gyA/QgFAGgFAGgApYl/QG/G9HkFC");
	this.shape_1.setTransform(201.3,230.3);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#000000").ss(1.5,1,1).p("AHLivIlXkpIHlB/QgQASgQATQgyA6gyA+QgFAHgFAGgApYMWIAA4rQG/G+HkFB");
	this.shape_2.setTransform(201.3,271);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#000000").ss(1.5,1,1).p("AHLivIlXkpIHlB/QgQASgQATQgyA6gyA+QgFAHgFAGgApYsVQG/G+HkFBQnjEQnAIcg");
	this.shape_3.setTransform(201.3,271);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#000000").ss(1.5,1,1).p("ACVlOIlWkpIHkB/QgQASgQATQgyA6gyA+QgFAHgFAGgAOPO2Qrgg9iRwtAuOu0QG/G+HkFBQnjEQnAIcg");
	this.shape_4.setTransform(232.3,286.9);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_5.setTransform(268.4,309.2);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_6.setTransform(342.7,309.2);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f().s("#000000").ss(2,1,1).p("AF3vAQqRHYhRHuQhQHrHrHQ");
	this.shape_7.setTransform(422.4,258.9);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f().s("#CCCCCC").ss(6,1,1).p("ABIABQAAAfgWAXQgVAWgdAAQgdAAgVgWQgVgXAAgfQAAggAVgWQAVgXAdAAQAdAAAVAXQAWAWAAAgg");
	this.shape_8.setTransform(484.5,254.5);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f().s("#000000").ss(2,1,1).p("AF3vAIgDACQqOHXhRHtQhQHrHrHQ");
	this.shape_9.setTransform(422.4,258.9);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_10.setTransform(342.9,294.6);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#000000").s().p("AgyA3QgVgXAAgfQAAggAVgWQAVgXAdAAQAdAAAVAXQAWAWAAAgQAAAfgWAXQgVAWgdAAQgdAAgVgWg");
	this.shape_11.setTransform(484.5,254.5);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_12.setTransform(342.9,288.7);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f().s("#000000").ss(2,1,1).p("AF3vAQgCACgCABQqNHWhRHtQhQHrHrHQ");
	this.shape_13.setTransform(422.4,258.9);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f().s("#000000").ss(1.5,1,1).p("");

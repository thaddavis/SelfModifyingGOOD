...
// stage content:
(lib.Fish_b = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.fifteen15.addEventListener("click", fl_ClickToGoToAndStopAtFrame_11.bind(this));
	...
	this.frame_1 = function() {
		this.sixteen16.addEventListener("click", fl_ClickToGoToAndStopAtFrame_12.bind(this));
	...
	this.frame_2 = function() {
		this.seventeen17.addEventListener("click", fl_ClickToGoToAndStopAtFrame_13.bind(this));
	...
	this.frame_3 = function() {
		this.eighteen18.addEventListener("click", fl_ClickToGoToAndStopAtFrame_14.bind(this));
	...
	this.frame_4 = function() {
		this.nineteen19.addEventListener("click", fl_ClickToGoToAndStopAtFrame_15.bind(this));
	...
	this.frame_5 = function() {
		this.twenty20.addEventListener("click", fl_ClickToGoToAndStopAtFrame_16.bind(this));
	...
	this.frame_6 = function() {
		this.twentyone21.addEventListener("click", fl_ClickToGoToAndStopAtFrame_17.bind(this));
	...
	this.frame_7 = function() {
		this.twentytwo22.addEventListener("click", fl_ClickToGoToAndStopAtFrame_18.bind(this));
	...
	this.frame_8 = function() {
		this.twentythree23.addEventListener("click", fl_ClickToGoToAndStopAtFrame_19.bind(this));
	...
	this.frame_9 = function() {
		this.twentyfour24.addEventListener("click", fl_ClickToGoToAndStopAtFrame_20.bind(this));
	...
	this.twentyfive25.setTransform(202.6,155);
	...
	this.twentyfour24.setTransform(333,229.5);
	...
	this.twentythree23.setTransform(437.5,111.5);
	...
	this.twentytwo22.setTransform(529.5,199.5,1,1,0,0,0,-0.5,6.5);
	...
	this.twentyone21.setTransform(348,281.5,1,1,0,0,0,-93.5,-26);
	...
	this.twenty20.setTransform(573.5,286.5);
	...
	this.nineteen19.setTransform(493,364.5);
	...
	this.eighteen18.setTransform(401,421);
	...
	this.seventeen17.setTransform(258,416.5);
	...
	this.sixteen16.setTransform(187.1,357);
	...
	this.fifteen15.setTransform(169.1,267);
	new cjs.ButtonHelper(this.fifteen15, 0, 1, 2, false, new lib.fifteen15(), 3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.fifteen15},{t:this.sixteen16},{t:this.seventeen17},{t:this.eighteen18},{t:this.nineteen19},{t:this.twenty20},{t:this.twentyone21},{t:this.twentytwo22},{t:this.twentythree23},{t:this.twentyfour24},{t:this.twentyfive25}]}).to({state:[]},11).wait(104));

	// Numbers
	this.sixteen16_1 = new lib.sixteen16();
	this.sixteen16_1.parent = this;
	this.sixteen16_1.setTransform(187.1,357);
	...
	this.seventeen17_1.setTransform(258,416.5);
	...
	this.eighteen18_1.setTransform(401,421);
	...
	this.nineteen19_1.setTransform(493,364.5);
	...
	this.twenty20_1.setTransform(573.5,286.5);
	...
	this.twentyone21_1.setTransform(348,281.5,1,1,0,0,0,-93.5,-26);
	...
	this.twentytwo22_1.setTransform(529.5,199.5,1,1,0,0,0,-0.5,6.5);
	...
	this.twentythree23_1.setTransform(437.5,111.5);
	...
	this.twentyfour24_1.setTransform(333,229.5);
	...
	this.twentyfive25_1.setTransform(202.6,155);
	new cjs.ButtonHelper(this.twentyfive25_1, 0, 1, 2, false, new lib.twentyfive25(), 3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.sixteen16_1}]},1).to({state:[{t:this.seventeen17_1}]},1).to({state:[{t:this.eighteen18_1}]},1).to({state:[{t:this.nineteen19_1}]},1).to({state:[{t:this.twenty20_1}]},1).to({state:[{t:this.twentyone21_1}]},1).to({state:[{t:this.twentytwo22_1}]},1).to({state:[{t:this.twentythree23_1}]},1).to({state:[{t:this.twentyfour24_1}]},1).to({state:[{t:this.twentyfive25_1}]},1).to({state:[]},1).wait(104));

	// Fish
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1.5,1,1).p("AnRsVQG/G+HkFBQnjEQnAIcg");
	this.shape.setTransform(187.8,271);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#000000").ss(1.5,1,1).p("AOPO2Qrgg9iRwtAuOu0QG/G+HkFBQnjEQnAIcg");
	this.shape_1.setTransform(232.3,286.9);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#000000").ss(1.5,1,1).p("AOyFkQAIgCAJAAQARgCAQgCIEEgWQABAAABAAQgGANgGANQhLCkidCeQgFAGgFAFQgnAlgqAmQggAbglAeQjhC0lSCuQCojoBZizQAJgSAHgRQANgaAKgZQBFingMhzIEqglAI0LXQreg9iSwtAzpyUQG/G/HlFBQnjEQnBIcg");
	this.shape_2.setTransform(267,309.2);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#000000").ss(1.5,1,1).p("AOjFkQAJgCAJAAQARgCAPgCIEFgWQABAAAAAAQgFANgGANQhLCkieCeQgFAGgFAFQgmAlgqAmQghAbgkAeAImLXQAMgaAKgZQBFingLhzIEpglAPdKvQCHggCUg2QgMARgNAQQi6DtlNDzQBGihAqiGQjiC0lSCuQCpjoBZizQAIgSAIgRQrfg9iRwtAz3yUQG/G/HlFBQnkEQnAIcg");
	this.shape_3.setTransform(268.4,309.2);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#000000").ss(1.5,1,1).p("AC+FkQAJgCAJAAQARgCAQgCIEEgWQABAAAAAAQgFANgGANQhLCkieCeQgFAGgFAFQgmAlgqAmQghAbgkAeQjhC0lSCuQCpjoBZizQAIgSAIgRQrgg9iRwtAi+LXQAMgaAKgZQBFingLhzIEoglAITJZQgMARgNAQQi6DtlMDzQBFihAqiGAD4KvQCHggCUg2AfdixQhQA2tkHdQkeCbj4BcA/cyUQG/G/HlFBQnkEQnAIcg");
	this.shape_4.setTransform(342.5,309.2);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_5.setTransform(342.9,301.5);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#CCCCCC").ss(6,1,1).p("ABIABQAAAfgWAXQgVAWgdAAQgdAAgVgWQgVgXAAgfQAAggAVgWQAVgXAdAAQAdAAAVAXQAWAWAAAgg");
	this.shape_6.setTransform(484.5,254.5);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_7.setTransform(342.9,301.5);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#000000").s().p("AgyA3QgVgXAAgfQAAggAVgWQAVgXAdAAQAdAAAVAXQAWAWAAAgQAAAfgWAXQgVAWgdAAQgdAAgVgWg");
	this.shape_8.setTransform(484.5,254.5);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f().s("#000000").ss(2,1,1).p("AF4u/IgaAQQp6HPhPHlQhRHrHsHQ");
	this.shape_9.setTransform(422.5,259);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_10.setTransform(342.9,294.7);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_11.setTransform(342.9,252.1);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f().s("#000000").ss(2,1,1).p("AF4u/IgBAAIgZAQQp6HPhPHlQhRHrHsHQ");
	this.shape_12.setTransform(422.5,259);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_13.setTransform(342.9,252.1);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f().s("#000000").ss(2,1,1).p("AF3vAQqRHYhRHuQhQHrHrHQ");
	this.shape_14.setTransform(422.4,258.9);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f().s("#000000").ss(1.5,1,1).p("");
	...
	this.instance_5.setTransform(320.4,240);
	this.instance_5.alpha = 0.41;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(13).to({_off:false},0).wait(6).to({alpha:0.641},0).wait(5).to({alpha:0.75},0).wait(91));

	// Sound Button
	this.instance_6 = new lib.sound_noSound();
	this.instance_6.parent = this;
	this.instance_6.setTransform(52.1,40.5,1,1,0,0,0,12.1,10.5);
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_16).wait(115));

	// Bubbles
	this.instance_7 = new lib.bubbles01();
	this.instance_7.parent = this;
	this.instance_7.setTransform(570.4,180.7);

	this.instance_8 = new lib.bubbles02();
	this.instance_8.parent = this;
	this.instance_8.setTransform(566.5,112.4);

	this.instance_9 = new lib.bubbles03();
	this.instance_9.parent = this;
	this.instance_9.setTransform(561.6,80.6);
	this.instance_9._off = true;

	this.instance_10 = new lib.bubbles05();
	this.instance_10.parent = this;
	this.instance_10.setTransform(556.7,-28.8);

	this.instance_11 = new lib.bubbles06();
	this.instance_11.parent = this;
	this.instance_11.setTransform(564.5,-54.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_7,p:{x:570.4,y:180.7}}]},45).to({state:[{t:this.instance_7,p:{x:568,y:170}}]},3).to({state:[{t:this.instance_8,p:{x:566.5,y:112.4}}]},3).to({state:[{t:this.instance_8,p:{x:562.1,y:88.9}}]},3).to({state:[{t:this.instance_9}]},3).to({state:[{t:this.instance_9}]},3).to({state:[{t:this.instance_9}]},3).to({state:[{t:this.instance_9}]},4).to({state:[{t:this.instance_10,p:{x:556.7,y:-28.8}}]},3).to({state:[{t:this.instance_10,p:{x:556.2,y:-42.9}}]},3).to({state:[{t:this.instance_10,p:{x:556.7,y:-28.8}}]},3).to({state:[{t:this.instance_11}]},3).to({state:[{t:this.instance_11}]},3).wait(33));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(57).to({_off:false},0).wait(3).to({x:559.7,y:53.2},0).wait(3).to({x:558.7,y:28.9},0).wait(4).to({x:558.2,y:7.4},0).to({_off:true},3).wait(45));

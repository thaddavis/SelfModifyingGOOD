...
(lib.thirtytwo32 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.thirtyone31 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
// stage content:
(lib.Fish_g = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.thirty30.addEventListener("click", fl_ClickToGoToAndStopAtFrame_32.bind(this));
	...
	this.frame_1 = function() {
		this.thirtyone31.addEventListener("click", fl_ClickToGoToAndStopAtFrame_33.bind(this));
	...
	this.frame_2 = function() {
		this.thirtytwo32.addEventListener("click", fl_ClickToGoToAndStopAtFrame_34.bind(this));
	...
	this.frame_3 = function() {
		this.thirtythree33.addEventListener("click", fl_ClickToGoToAndStopAtFrame_35.bind(this));
	...
	this.frame_4 = function() {
		this.thirtyfour34.addEventListener("click", fl_ClickToGoToAndStopAtFrame_36.bind(this));
	...
	this.frame_5 = function() {
		this.thirtyfive35.addEventListener("click", fl_ClickToGoToAndStopAtFrame_37.bind(this));
	...
	this.frame_6 = function() {
		this.thirtysix36.addEventListener("click", fl_ClickToGoToAndStopAtFrame_38.bind(this));
	...
	this.frame_7 = function() {
		this.thirtyseven37.addEventListener("click", fl_ClickToGoToAndStopAtFrame_39.bind(this));
	...
	this.frame_8 = function() {
		this.thirtyeight38.addEventListener("click", fl_ClickToGoToAndStopAtFrame_40.bind(this));
	...
	this.frame_9 = function() {
		this.thirtynine39.addEventListener("click", fl_ClickToGoToAndStopAtFrame_41.bind(this));
	...
	this.frame_10 = function() {
		this.forty40.addEventListener("click", fl_ClickToGoToAndPlayFromFrame_3.bind(this));
	...
	this.forty40.setTransform(471,130);
	...
	this.thirtynine39.setTransform(361.5,190);
	...
	this.thirtyeight38.setTransform(239.1,114.5);
	...
	this.thirtyseven37.setTransform(175.1,272.5);
	...
	this.thirtysix36.setTransform(283.1,268.5);
	...
	this.thirtyfive35.setTransform(207.1,334);
	...
	this.thirtyfour34.setTransform(269.6,402);
	...
	this.thirtythree33.setTransform(357.5,316.6);
	new cjs.ButtonHelper(this.thirtythree33, 0, 1, 2, false, new lib.thirtythree33(), 3);

	this.thirtytwo32 = new lib.thirtytwo32();
	this.thirtytwo32.parent = this;
	this.thirtytwo32.setTransform(454.5,378.6);
	new cjs.ButtonHelper(this.thirtytwo32, 0, 1, 2, false, new lib.thirtytwo32(), 3);

	this.thirtyone31 = new lib.thirtyone31();
	this.thirtyone31.parent = this;
	this.thirtyone31.setTransform(536.5,333.1);
	new cjs.ButtonHelper(this.thirtyone31, 0, 1, 2, false, new lib.thirtyone31(), 3);

	this.thirty30 = new lib.thirty30();
	this.thirty30.parent = this;
	this.thirty30.setTransform(544.5,225.1);
	new cjs.ButtonHelper(this.thirty30, 0, 1, 2, false, new lib.thirty30(), 3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.thirty30},{t:this.thirtyone31},{t:this.thirtytwo32},{t:this.thirtythree33},{t:this.thirtyfour34},{t:this.thirtyfive35},{t:this.thirtysix36},{t:this.thirtyseven37},{t:this.thirtyeight38},{t:this.thirtynine39},{t:this.forty40}]}).to({state:[]},12).wait(103));

	// Numbers
	this.thirtyone31_1 = new lib.thirtyone31();
	this.thirtyone31_1.parent = this;
	this.thirtyone31_1.setTransform(536.5,333.1);
	new cjs.ButtonHelper(this.thirtyone31_1, 0, 1, 2, false, new lib.thirtyone31(), 3);

	this.thirtytwo32_1 = new lib.thirtytwo32();
	this.thirtytwo32_1.parent = this;
	this.thirtytwo32_1.setTransform(454.5,378.6);
	new cjs.ButtonHelper(this.thirtytwo32_1, 0, 1, 2, false, new lib.thirtytwo32(), 3);

	this.thirtythree33_1 = new lib.thirtythree33();
	this.thirtythree33_1.parent = this;
	this.thirtythree33_1.setTransform(357.5,316.6);
	...
	this.thirtyfour34_1.setTransform(269.6,402);
	...
	this.thirtyfive35_1.setTransform(207.1,334);
	...
	this.thirtysix36_1.setTransform(283.1,268.5);
	...
	this.thirtyseven37_1.setTransform(175.1,272.5);
	...
	this.thirtyeight38_1.setTransform(239.1,114.5);
	...
	this.thirtynine39_1.setTransform(361.5,190);
	...
	this.forty40_1.setTransform(471,130);
	...
	// Fish
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1.5,1,1).p("Akto2QADACAEADQBbCrBOCRQAGAMAHAMQF1K+ApBW");
	this.shape.setTransform(513.7,232.8);
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#000000").ss(1.5,1,1).p("Agvo2QADACAEADQBVChBKCKQAEAJAFAIQACAEACADQAEAJAFAIQF2K+ApBWABzCnQAABSgmBBQgXAoglAiQhYBTh5AIQgOABgOAAQiLAAhihcQglgigXgoQgmhCAAhRQAAgfAFgdQAJgtAXgoQAAgBABAAQAXgnAlgjQAKgJAKgIQBchKB9AAQCLAABiBbQAlAiAXAoQAmBCAABQg");
	this.shape_2.setTransform(488.3,232.8);
	...
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#000000").ss(1.5,1,1).p("Agdt+QAEACADADQBVChBKCKQAFAJAEAIQACAEACADQAEAJAFAIQF2K+AqBWACFigQAABSgmBBQgXAnglAiQhYBTh5AIQgOABgOAAQiKAAhihcQgmgigXgnQgmhCAAhRQAAgfAGgdQAJgtAWgoQABAAAAgBQAXgoAmgjQAJgJAKgIQBchKB9AAQCLAABiBbQAlAjAXAoQAmBCAABQgAJED7QAAAMu6IPQhpA5hkAwAI7D7IhygC");
	this.shape_4.setTransform(486.5,265.6);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_5.setTransform(442.9,298.3);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_6.setTransform(420.3,301.3);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_7.setTransform(389.9,301.3);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_8.setTransform(378.7,301.3);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_9.setTransform(342.9,301.3);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_10.setTransform(342.9,284.6);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_11.setTransform(342.9,264.8);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f().s("#000000").ss(2,1,1).p("AF3vAQqRHYhRHuQgxEvCoEkQAKASALARQBmCkCpCh");
	this.shape_12.setTransform(422.4,258.9);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f().s("#000000").ss(1.5,1,1).p("");

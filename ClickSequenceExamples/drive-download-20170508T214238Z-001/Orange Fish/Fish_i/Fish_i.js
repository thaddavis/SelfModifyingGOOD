...
// stage content:
(lib.Fish_i = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.five05.addEventListener("click", fl_ClickToGoToAndStopAtFrame_21.bind(this));
	...
	this.frame_1 = function() {
		...
		*/
		...
		this.six06.addEventListener("click", fl_ClickToGoToAndStopAtFrame_22.bind(this));
	...
	this.frame_2 = function() {
		...
		*/
		...
		this.seven07.addEventListener("click", fl_ClickToGoToAndStopAtFrame_23.bind(this));
	...
	this.frame_3 = function() {
		...
		*/
		...
		this.eight08.addEventListener("click", fl_ClickToGoToAndStopAtFrame_24.bind(this));
	...
	this.frame_4 = function() {
		...
		*/
		...
		this.nine09.addEventListener("click", fl_ClickToGoToAndStopAtFrame_25.bind(this));
	...
	this.frame_5 = function() {
		...
		*/
		...
		this.ten10.addEventListener("click", fl_ClickToGoToAndStopAtFrame_26.bind(this));
	...
	this.frame_6 = function() {
		...
		*/
		...
		this.eleven11.addEventListener("click", fl_ClickToGoToAndStopAtFrame_27.bind(this));
	...
	this.frame_7 = function() {
		...
		*/
		...
		this.twelve12.addEventListener("click", fl_ClickToGoToAndStopAtFrame_28.bind(this));
	...
	this.frame_8 = function() {
		...
		*/
		...
		this.thirteen13.addEventListener("click", fl_ClickToGoToAndStopAtFrame_29.bind(this));
	...
	this.frame_9 = function() {
		...
		*/
		...
		this.fourteen14.addEventListener("click", fl_ClickToGoToAndStopAtFrame_30.bind(this));
	...
	this.frame_10 = function() {
		...
		*/
		...
		this.fifteen15.addEventListener("click", fl_ClickToGoToAndStopAtFrame_31.bind(this));
	...
	this.frame_11 = function() {
		...
		*/
		...
		this.sixteen16.addEventListener("click", fl_ClickToGoToAndStopAtFrame_32.bind(this));
	...
	this.frame_12 = function() {
		...
		*/
		...
		this.seventeen17.addEventListener("click", fl_ClickToGoToAndStopAtFrame_33.bind(this));
	...
	this.frame_13 = function() {
		this.eighteen18.addEventListener("click", fl_ClickToGoToAndStopAtFrame_34.bind(this));
	...
	this.frame_14 = function() {
		this.nineteen19.addEventListener("click", fl_ClickToGoToAndStopAtFrame_35.bind(this));
	...
	this.frame_15 = function() {
		this.twenty20.addEventListener("click", fl_ClickToGoToAndPlayFromFrame_2.bind(this));
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(1).call(this.frame_1).wait(1).call(this.frame_2).wait(1).call(this.frame_3).wait(1).call(this.frame_4).wait(1).call(this.frame_5).wait(1).call(this.frame_6).wait(1).call(this.frame_7).wait(1).call(this.frame_8).wait(1).call(this.frame_9).wait(1).call(this.frame_10).wait(1).call(this.frame_11).wait(1).call(this.frame_12).wait(1).call(this.frame_13).wait(1).call(this.frame_14).wait(1).call(this.frame_15).wait(105));

	// Numbers All
	this.twenty20 = new lib.twenty20();
	this.twenty20.parent = this;
	this.twenty20.setTransform(105.6,266.6);
	...
	this.nineteen19.setTransform(214.6,334.1);
	...
	this.eighteen18.setTransform(171.6,267.6);
	...
	this.seventeen17.setTransform(192.1,175.1);
	...
	this.sixteen16.setTransform(275.6,261.1);
	...
	this.fifteen15.setTransform(260.6,115.1);
	...
	this.fourteen14.setTransform(325,86.1);
	...
	this.thirteen13.setTransform(328,213.1);
	...
	this.twelve12_1.setTransform(420.5,98.6);
	...
	this.thirteen13_1.setTransform(328,213.1);
	...
	this.fourteen14_1.setTransform(325,86.1);
	...
	this.fifteen15_1.setTransform(260.6,115.1);
	...
	this.sixteen16_1.setTransform(275.6,261.1);
	...
	this.seventeen17_1.setTransform(192.1,175.1);
	...
	this.eighteen18_1.setTransform(171.6,267.6);
	...
	this.nineteen19_1.setTransform(214.6,334.1);
	...
	this.twenty20_1.setTransform(105.6,266.6);
	...
	// Bubbles
	this.instance = new lib.bubbles01();
	this.instance.parent = this;
	this.instance.setTransform(570.4,180.7);

	this.instance_1 = new lib.bubbles02();
	this.instance_1.parent = this;
	this.instance_1.setTransform(566.5,112.4);

	this.instance_2 = new lib.bubbles03();
	this.instance_2.parent = this;
	this.instance_2.setTransform(561.6,80.6);
	this.instance_2._off = true;

	this.instance_3 = new lib.bubbles05();
	this.instance_3.parent = this;
	this.instance_3.setTransform(556.7,-28.8);

	this.instance_4 = new lib.bubbles06();
	this.instance_4.parent = this;
	this.instance_4.setTransform(564.5,-54.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance,p:{x:570.4,y:180.7}}]},45).to({state:[{t:this.instance,p:{x:568,y:170}}]},3).to({state:[{t:this.instance_1,p:{x:566.5,y:112.4}}]},3).to({state:[{t:this.instance_1,p:{x:562.1,y:88.9}}]},3).to({state:[{t:this.instance_2}]},3).to({state:[{t:this.instance_2}]},3).to({state:[{t:this.instance_2}]},3).to({state:[{t:this.instance_2}]},4).to({state:[{t:this.instance_3,p:{x:556.7,y:-28.8}}]},3).to({state:[{t:this.instance_3,p:{x:556.2,y:-42.9}}]},3).to({state:[{t:this.instance_3,p:{x:556.7,y:-28.8}}]},3).to({state:[{t:this.instance_4}]},3).to({state:[{t:this.instance_4}]},3).wait(38));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(57).to({_off:false},0).wait(3).to({x:559.7,y:53.2},0).wait(3).to({x:558.7,y:28.9},0).wait(4).to({x:558.2,y:7.4},0).to({_off:true},3).wait(50));

	// Fish
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1.5,1,1).p("Amjp5QANAGANAHQBfAtBfA+QAFAEAGAEIABAAQACABABABQAGAEAGAEQARAfAQAeQBICIBAB3QAGAMAGANQF2K9ApBX");
	this.shape.setTransform(501.9,226.2);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#CCCCCC").ss(6,1,1).p("ABIABQAAAfgWAXQgVAWgdAAQgdAAgVgWQgVgXAAgfQAAggAVgWQAVgXAdAAQAdAAAVAXQAWAWAAAgg");
	this.shape_1.setTransform(484.5,254.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#000000").ss(1.5,1,1).p("Akbp5QANAGANAHQBfAtBfA+QAFAEAGAEIABAAQACABABABQAGAEAGAEQARAfAQAeQBHCIBAB3QAGAMAHANQF2K9ApBXABzDqQAAA/gXA2QgZA5gyAvQgeAcgiAUQhNArhgAAQiLAAhihbQhihbAAiCQAAiCBihcQARgOASgNQA7grBIgNQAigHAlAAQAlAAAjAHQBdARBIBCQADADACADQANAMAMAOQAcAiARAnQAXA2AAA/g");
	this.shape_2.setTransform(488.3,226.2);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("AgyA3QgVgXAAgfQAAggAVgWQAVgXAdAAQAdAAAVAXQAWAWAAAgQAAAfgWAXQgVAWgdAAQgdAAgVgWg");
	this.shape_3.setTransform(484.5,254.5);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_4.setTransform(486.3,259.1);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_5.setTransform(442.9,291.7);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_6.setTransform(420.3,294.6);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f().s("#000000").ss(2,1,1).p("AF3vAQgWAQgWAQQgaATgYATQo5G2hLHKQhQHrHrHQ");
	this.shape_7.setTransform(422.4,258.9);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_8.setTransform(420.3,294.6);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f().s("#000000").ss(2,1,1).p("AF3vAQgxAjgtAjQo5G2hLHKQhQHrHrHQ");
	this.shape_9.setTransform(422.4,258.9);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_10.setTransform(420.3,288.7);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_11.setTransform(420.3,252.1);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_12.setTransform(417.3,252.1);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_13.setTransform(417.3,252.1);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_14.setTransform(392.6,252.1);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_15.setTransform(389.9,252.1);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_16.setTransform(378.7,252.1);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_17.setTransform(342.9,252.1);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_18.setTransform(342.9,252.1);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_19.setTransform(342.9,252.1);

	this.instance_5 = new lib.fish();
	this.instance_5.parent = this;
	this.instance_5.setTransform(343.9,252.8,0.799,0.799,0,0,0,293,-0.2);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.instance_6 = new lib.fishTransition01();
	this.instance_6.parent = this;
	this.instance_6.setTransform(343.8,252.7,0.799,0.799,0,0,0,292.9,-0.5);

	this.instance_7 = new lib.fishSwimmingLookingAtYou();
	this.instance_7.parent = this;
	this.instance_7.setTransform(592.5,257.7,0.799,0.799,0,0,0,292.9,-0.5);

	this.instance_8 = new lib.fishTransition01Back();
	this.instance_8.parent = this;
	this.instance_8.setTransform(343.5,251.3,0.799,0.799,0,0,0,292.9,-0.5);

	this.instance_9 = new lib.fish01Swimming02();
	this.instance_9.parent = this;
	this.instance_9.setTransform(590.5,256.9,0.799,0.799,0,0,0,293.1,-0.5);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1}]},1).to({state:[{t:this.shape_3},{t:this.shape_4},{t:this.shape_1}]},1).to({state:[{t:this.shape_3},{t:this.shape_5},{t:this.shape_1}]},1).to({state:[{t:this.shape_3},{t:this.shape_6},{t:this.shape_1}]},1).to({state:[{t:this.shape_3},{t:this.shape_8},{t:this.shape_1},{t:this.shape_7}]},1).to({state:[{t:this.shape_3},{t:this.shape_10},{t:this.shape_1},{t:this.shape_9}]},1).to({state:[{t:this.shape_3},{t:this.shape_9},{t:this.shape_11},{t:this.shape_1}]},1).to({state:[{t:this.shape_3},{t:this.shape_9},{t:this.shape_12},{t:this.shape_1}]},1).to({state:[{t:this.shape_3},{t:this.shape_13},{t:this.shape_9},{t:this.shape_1}]},1).to({state:[{t:this.shape_3},{t:this.shape_14},{t:this.shape_9},{t:this.shape_1}]},1).to({state:[{t:this.shape_3},{t:this.shape_15},{t:this.shape_9},{t:this.shape_1}]},1).to({state:[{t:this.shape_3},{t:this.shape_16},{t:this.shape_9},{t:this.shape_1}]},1).to({state:[{t:this.shape_3},{t:this.shape_17},{t:this.shape_9},{t:this.shape_1}]},1).to({state:[{t:this.shape_3},{t:this.shape_18},{t:this.shape_9},{t:this.shape_1}]},1).to({state:[{t:this.shape_3},{t:this.shape_19},{t:this.shape_1},{t:this.shape_9}]},1).to({state:[{t:this.instance_5}]},2).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},2).to({state:[{t:this.instance_6}]},4).to({state:[{t:this.instance_7}]},5).to({state:[{t:this.instance_8}]},10).to({state:[{t:this.instance_9}]},5).to({state:[{t:this.instance_9}]},5).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(18).to({_off:false},0).wait(1).to({regY:-0.5,x:343.8,y:252.5,alpha:0.2},0).wait(1).to({alpha:0.4},0).wait(1).to({alpha:0.6},0).wait(1).to({alpha:0.8},0).wait(1).to({alpha:1},0).wait(1).to({regX:292.9,y:252.7},0).wait(2).to({_off:true},4).wait(90));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(50).to({_off:false},0).wait(6).to({regX:-18.5,regY:-6.5,x:350.6,y:233},0).wait(1).to({x:362.1,y:215.2},0).wait(1).to({x:376.8,y:200},0).wait(1).to({x:395.1,y:189.5},0).wait(1).to({x:415.9,y:186.1},0).wait(1).to({x:436.8,y:189.5},0).wait(1).to({x:456.3,y:197.5},0).wait(1).to({x:474.5,y:208.5},0).wait(1).to({x:484.2,y:236.7},0).wait(1).to({x:495.4,y:264.4},0).wait(1).to({x:508.3,y:291.3},0).wait(1).to({x:523.5,y:317},0).wait(1).to({x:541.2,y:341.1},0).wait(1).to({x:561.9,y:362.6},0).wait(1).to({x:585.7,y:380.5},0).wait(1).to({x:612.5,y:393.7},0).wait(1).to({x:641.3,y:401.3},0).wait(1).to({x:671.1,y:403.4},0).wait(1).to({x:700.8,y:400.6},0).wait(1).to({x:729.8,y:393.8},0).wait(1).to({x:758.1,y:384},0).wait(1).to({x:785.3,y:371.9},0).wait(1).to({x:811.7,y:357.9},0).wait(1).to({x:837.3,y:342.5},0).wait(1).to({x:844.6,y:338.8},0).wait(1).to({x:851.9,y:335.1},0).wait(1).to({x:859.2,y:331.4},0).wait(1).to({x:866.4,y:327.7},0).wait(1).to({x:873.7,y:324},0).wait(1).to({x:881,y:320.3},0).wait(1).to({x:888.3,y:316.6},0).wait(1).to({x:895.5,y:312.9},0).wait(1).to({x:902.8,y:309.2},0).wait(1).to({x:910.1,y:305.5},0).wait(31));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(18).to({_off:false},0).wait(6).to({alpha:0.641},0).wait(5).to({alpha:0.75},0).wait(91));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_20).wait(120));

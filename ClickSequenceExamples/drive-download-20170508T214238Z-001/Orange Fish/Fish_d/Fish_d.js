...
// stage content:
(lib.Fish_d = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.thirtyfive35.addEventListener("click", fl_ClickToGoToAndStopAtFrame_22.bind(this));
	...
	this.frame_1 = function() {
		this.thirtysix36.addEventListener("click", fl_ClickToGoToAndStopAtFrame_23.bind(this));
	...
	this.frame_2 = function() {
		this.thirtyseven37.addEventListener("click", fl_ClickToGoToAndStopAtFrame_24.bind(this));
	...
	this.frame_3 = function() {
		this.thirtyeight38.addEventListener("click", fl_ClickToGoToAndStopAtFrame_25.bind(this));
	...
	this.frame_4 = function() {
		this.thirtynine39.addEventListener("click", fl_ClickToGoToAndStopAtFrame_26.bind(this));
	...
	this.frame_5 = function() {
		this.forty40.addEventListener("click", fl_ClickToGoToAndStopAtFrame_27.bind(this));
	...
	this.frame_6 = function() {
		this.fortyone41.addEventListener("click", fl_ClickToGoToAndStopAtFrame_28.bind(this));
	...
	this.frame_7 = function() {
		this.fortytwo42.addEventListener("click", fl_ClickToGoToAndStopAtFrame_29.bind(this));
	...
	this.frame_8 = function() {
		this.fortythree43.addEventListener("click", fl_ClickToGoToAndStopAtFrame_30.bind(this));
	...
	this.frame_9 = function() {
		this.foyrtyfour44.addEventListener("click", fl_ClickToGoToAndStopAtFrame_31.bind(this));
	...
	this.frame_10 = function() {
		this.fortyfive45.addEventListener("click", fl_ClickToGoToAndPlayFromFrame_2.bind(this));
	...
	this.fortyfive45.setTransform(576.5,288.5);
	new cjs.ButtonHelper(this.fortyfive45, 0, 1, 2, false, new lib.fortyfive45(), 3);

	this.foyrtyfour44 = new lib.fortyfour44();
	this.foyrtyfour44.parent = this;
	this.foyrtyfour44.setTransform(416,395.1);
	new cjs.ButtonHelper(this.foyrtyfour44, 0, 1, 2, false, new lib.fortyfour44(), 3);

	this.fortythree43 = new lib.fortythree43();
	this.fortythree43.parent = this;
	this.fortythree43.setTransform(433,307.6);
	...
	this.fortytwo42.setTransform(300,326.1);
	...
	this.fortyone41.setTransform(217.6,332.1);
	...
	this.forty40.setTransform(171.6,271.6);
	...
	this.thirtynine39.setTransform(296.1,259.1);
	...
	this.thirtyeight38.setTransform(267.6,120.1);
	...
	this.thirtyseven37.setTransform(372,199.1);
	...
	this.thirtysix36.setTransform(532,191.6);
	...
	this.thirtyfive35.setTransform(459,126.1);
	new cjs.ButtonHelper(this.thirtyfive35, 0, 1, 2, false, new lib.thirtyfive35(), 3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.thirtyfive35},{t:this.thirtysix36},{t:this.thirtyseven37},{t:this.thirtyeight38},{t:this.thirtynine39},{t:this.forty40},{t:this.fortyone41},{t:this.fortytwo42},{t:this.fortythree43},{t:this.foyrtyfour44},{t:this.fortyfive45}]}).to({state:[]},12).wait(103));

	// Numbers
	this.thirtysix36_1 = new lib.thirtysix36();
	this.thirtysix36_1.parent = this;
	this.thirtysix36_1.setTransform(532,191.6);
	...
	this.thirtyseven37_1.setTransform(372,199.1);
	...
	this.thirtyeight38_1.setTransform(267.6,120.1);
	...
	this.thirtynine39_1.setTransform(296.1,259.1);
	...
	this.forty40_1.setTransform(171.6,271.6);
	...
	this.fortyone41_1.setTransform(217.6,332.1);
	...
	this.fortytwo42_1.setTransform(300,326.1);
	...
	this.fortythree43_1.setTransform(433,307.6);
	new cjs.ButtonHelper(this.fortythree43_1, 0, 1, 2, false, new lib.fortythree43(), 3);

	this.foyrtyfour44_1 = new lib.fortyfour44();
	this.foyrtyfour44_1.parent = this;
	this.foyrtyfour44_1.setTransform(416,395.1);
	new cjs.ButtonHelper(this.foyrtyfour44_1, 0, 1, 2, false, new lib.fortyfour44(), 3);

	this.fortyfive45_1 = new lib.fortyfive45();
	this.fortyfive45_1.parent = this;
	this.fortyfive45_1.setTransform(576.5,288.5);
	new cjs.ButtonHelper(this.fortyfive45_1, 0, 1, 2, false, new lib.fortyfive45(), 3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.thirtysix36_1}]},1).to({state:[{t:this.thirtyseven37_1}]},1).to({state:[{t:this.thirtyeight38_1}]},1).to({state:[{t:this.thirtynine39_1}]},1).to({state:[{t:this.forty40_1}]},1).to({state:[{t:this.fortyone41_1}]},1).to({state:[{t:this.fortytwo42_1}]},1).to({state:[{t:this.fortythree43_1}]},1).to({state:[{t:this.foyrtyfour44_1}]},1).to({state:[{t:this.fortyfive45_1}]},1).to({state:[]},2).wait(103));
	...
	// Fish
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1.5,1,1).p("ADPEZQBlAcBkAuQB6A4B5BSQABABABACADPEZItbsIICpMSQFdhqFVBgg");
	this.shape.setTransform(419.1,127.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#000000").ss(1.5,1,1).p("AhckgItcsJICpMTQCvg1CtgDQCsgCCrAwQBjAcBlAuQB6A4B5BRIABABIAAABQAAABABABQBaCoBNCPQAGANAHAMQCZEhBiC5QCqFBAAAGQgBABgBABAOxQoIhygC");
	this.shape_1.setTransform(449.2,184.4);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#000000").ss(2,1,1).p("AF3vAQqHHRhYHnQgBAIgCAGQggDFA8DBQBaEfElEW");
	this.shape_2.setTransform(422.4,258.9);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#000000").ss(1.5,1,1).p("AhckgItcsJICpMTQCvg1CtgDQCKgCCJAeQAiAIAiAKQBjAcBlAuQB6A4B5BRIABABIAAABQAAABABABQBaCoBNCPQAGANAHAMQCZEhBiC5QCqFBAAAGQgBABgBABAOxQoIhygC");
	this.shape_3.setTransform(449.2,184.4);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#000000").ss(1.5,1,1).p("Aqlg4QDQiKDNhFQAUgIAUgGIr9oXgAHYkgItbsJICpMTQCvg1CsgDQCKgCCJAeQAiAIAiAKQBlAcBkAuQB6A4B5BRIABABIAAABQABABAAABQBaCoBNCPQAHANAGAMQCaEhBhC5QCqFBAAAGQAAABgCABAXmQoIhygCAwQDtQAIgIAIgIQAOgNANgMQABgBABAAQCbiOCbhnItBlsIHdKE");
	this.shape_4.setTransform(392.6,184.4);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("#000000").ss(2,1,1).p("AF3vAQgDACgCACQjiCiicCmQgYAZgXAZQj5EZg0EhQgBAIgCAGQggDFA8DBQBaEfElEW");
	this.shape_5.setTransform(422.4,258.9);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_6.setTransform(378.7,184.4);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_7.setTransform(342.9,213.9);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_8.setTransform(342.9,229.8);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_9.setTransform(342.9,252.1);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f().s("#CCCCCC").ss(6,1,1).p("ABIABQAAATgIAPQgFALgJAJQgVAWgdAAQgdAAgVgWQgIgJgGgLQgHgPAAgTQAAggAVgWQAVgXAdAAQAdAAAVAXQAWAWAAAgg");
	this.shape_10.setTransform(484.5,254.5);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_11.setTransform(342.9,252.1);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#000000").s().p("AgyA3QgIgJgFgLQgIgPAAgTQAAggAVgWQAVgXAdAAQAdAAAVAXQAWAWAAAgQAAATgIAPQgFALgJAJQgVAWgdAAQgdAAgVgWg");
	this.shape_12.setTransform(484.5,254.5);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_13.setTransform(342.9,252.1);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f().s("#000000").ss(1.5,1,1).p("");
	...
	// Border
	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f().s("#000000").ss(1,1,1).p("Egx/glfMBj/AAAMAAABK/Mhj/AAAg");
	this.shape_15.setTransform(320,240);

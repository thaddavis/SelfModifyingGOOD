...
// stage content:
(lib.Fish_j = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.ten10.addEventListener("click", fl_ClickToGoToAndStopAtFrame_21.bind(this));
	...
	this.frame_1 = function() {
		this.eleven11.addEventListener("click", fl_ClickToGoToAndStopAtFrame_22.bind(this));
	...
	this.frame_2 = function() {
		this.twelve12.addEventListener("click", fl_ClickToGoToAndStopAtFrame_23.bind(this));
	...
	this.frame_3 = function() {
		...
		*/
		...
		this.thirteen13.addEventListener("click", fl_ClickToGoToAndStopAtFrame_24.bind(this));
	...
	this.frame_4 = function() {
		...
		*/
		...
		this.fourteen14.addEventListener("click", fl_ClickToGoToAndStopAtFrame_36.bind(this));
	...
	this.frame_5 = function() {
		...
		*/
		...
		this.fifteen15.addEventListener("click", fl_ClickToGoToAndStopAtFrame_26.bind(this));
	...
	this.frame_6 = function() {
		...
		*/
		...
		this.sixteen16.addEventListener("click", fl_ClickToGoToAndStopAtFrame_27.bind(this));
	...
	this.frame_7 = function() {
		...
		*/
		...
		this.seventeen17.addEventListener("click", fl_ClickToGoToAndStopAtFrame_28.bind(this));
	...
	this.frame_8 = function() {
		...
		*/
		...
		this.eighteen18.addEventListener("click", fl_ClickToGoToAndStopAtFrame_29.bind(this));
	...
	this.frame_9 = function() {
		...
		*/
		...
		this.nineteen19.addEventListener("click", fl_ClickToGoToAndStopAtFrame_30.bind(this));
	...
	this.frame_10 = function() {
		...
		*/
		...
		this.twenty20.addEventListener("click", fl_ClickToGoToAndStopAtFrame_31.bind(this));
	...
	this.frame_11 = function() {
		...
		*/
		...
		this.twentyone21.addEventListener("click", fl_ClickToGoToAndStopAtFrame_32.bind(this));
	...
	this.frame_12 = function() {
		...
		*/
		...
		this.twentytwo22.addEventListener("click", fl_ClickToGoToAndStopAtFrame_33.bind(this));
	...
	this.frame_13 = function() {
		...
		*/
		...
		this.twentythree23.addEventListener("click", fl_ClickToGoToAndStopAtFrame_34.bind(this));
	...
	this.frame_14 = function() {
		...
		*/
		...
		this.twentyfour24.addEventListener("click", fl_ClickToGoToAndStopAtFrame_35.bind(this));
	...
	this.frame_15 = function() {
		...
		*/
		...
		this.twentyfive25.addEventListener("click", fl_ClickToGoToAndPlayFromFrame_2.bind(this));
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(1).call(this.frame_1).wait(1).call(this.frame_2).wait(1).call(this.frame_3).wait(1).call(this.frame_4).wait(1).call(this.frame_5).wait(1).call(this.frame_6).wait(1).call(this.frame_7).wait(1).call(this.frame_8).wait(1).call(this.frame_9).wait(1).call(this.frame_10).wait(1).call(this.frame_11).wait(1).call(this.frame_12).wait(1).call(this.frame_13).wait(1).call(this.frame_14).wait(1).call(this.frame_15).wait(100));

	// Numbers All
	this.twentyfive25 = new lib.twentyfive25();
	this.twentyfive25.parent = this;
	this.twentyfive25.setTransform(185,160.1);
	...
	this.twentyfour24.setTransform(324,228.1);
	...
	this.twentythree23.setTransform(389,186.1);
	...
	this.twentytwo22.setTransform(250,103.1);
	...
	this.twentyone21.setTransform(323,75.1);
	...
	this.twenty20.setTransform(459,120.1);
	...
	this.nineteen19.setTransform(354,302.1);
	...
	this.eighteen18.setTransform(539,219.1);
	...
	this.seventeen17.setTransform(424,296.1);
	...
	this.sixteen16.setTransform(480,366.1);
	...
	this.fifteen15.setTransform(390,431.1);
	...
	this.fourteen14.setTransform(256,400.1);
	...
	this.thirteen13.setTransform(210,336.1);
	...
	this.twelve12_1.setTransform(276,291.1);
	...
	this.thirteen13_1.setTransform(210,336.1);
	...
	this.fourteen14_1.setTransform(256,400.1);
	...
	this.fifteen15_1.setTransform(390,431.1);
	...
	this.sixteen16_1.setTransform(480,366.1);
	...
	this.seventeen17_1.setTransform(424,296.1);
	...
	this.eighteen18_1.setTransform(539,219.1);
	...
	this.nineteen19_1.setTransform(354,302.1);
	...
	this.twenty20_1.setTransform(459,120.1);
	...
	this.twentyone21_1.setTransform(323,75.1);
	...
	this.twentytwo22_1.setTransform(250,103.1);
	...
	this.twentythree23_1.setTransform(389,186.1);
	...
	this.twentyfour24_1.setTransform(324,228.1);
	...
	this.twentyfive25_1.setTransform(185,160.1);
	new cjs.ButtonHelper(this.twentyfive25_1, 0, 1, 2, false, new lib.twentyfive25(), 3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.eleven11_1}]},1).to({state:[{t:this.twelve12_1}]},1).to({state:[{t:this.thirteen13_1}]},1).to({state:[{t:this.fourteen14_1}]},1).to({state:[{t:this.fifteen15_1}]},1).to({state:[{t:this.sixteen16_1}]},1).to({state:[{t:this.seventeen17_1}]},1).to({state:[{t:this.eighteen18_1}]},1).to({state:[{t:this.nineteen19_1}]},1).to({state:[{t:this.twenty20_1}]},1).to({state:[{t:this.twentyone21_1}]},1).to({state:[{t:this.twentytwo22_1}]},1).to({state:[{t:this.twentythree23_1}]},1).to({state:[{t:this.twentyfour24_1}]},1).to({state:[{t:this.twentyfive25_1}]},1).to({state:[]},2).wait(98));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance,p:{x:570.4,y:180.7}}]},45).to({state:[{t:this.instance,p:{x:568,y:170}}]},3).to({state:[{t:this.instance_1,p:{x:566.5,y:112.4}}]},3).to({state:[{t:this.instance_1,p:{x:562.1,y:88.9}}]},3).to({state:[{t:this.instance_2}]},3).to({state:[{t:this.instance_2}]},3).to({state:[{t:this.instance_2}]},3).to({state:[{t:this.instance_2}]},4).to({state:[{t:this.instance_3,p:{x:556.7,y:-28.8}}]},3).to({state:[{t:this.instance_3,p:{x:556.2,y:-42.9}}]},3).to({state:[{t:this.instance_3,p:{x:556.7,y:-28.8}}]},3).to({state:[{t:this.instance_4}]},3).to({state:[{t:this.instance_4}]},3).wait(33));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(57).to({_off:false},0).wait(3).to({x:559.7,y:53.2},0).wait(3).to({x:558.7,y:28.9},0).wait(4).to({x:558.2,y:7.4},0).to({_off:true},3).wait(45));

	// Fish
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1.5,1,1).p("AAAMWIAA4r");
	this.shape.setTransform(141.2,271);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#000000").ss(1.5,1,1).p("AnRMWIAA4rQG/G+HkFB");
	this.shape_1.setTransform(187.8,271);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#000000").ss(1.5,1,1).p("AHLivQAFgGAFgHQAyg+Ayg6QAQgTAQgSInlh/gAFUgVQAxhCAyg+QAFgIAFgFQAFgHAFgGApYMWIAA4rQG/G+HkFB");
	this.shape_2.setTransform(201.3,271);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#000000").ss(1.5,1,1).p("AHLivQAFgGAFgHQAyg+Ayg6QAQgTAQgSInlh/gAFUgVQAxhCAyg+QAFgIAFgFQAFgHAFgGApYMWIAA4rQG/G+HkFBQnjEQnAIcg");
	this.shape_3.setTransform(201.3,271);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#000000").ss(1.5,1,1).p("ACVlOQAFgGAFgHQAyg+Ayg6QAQgTAQgSInkh/gAOPO2Qrgg9iRwtQAxhDAyg9QAFgIAFgFQAFgHAFgGAuOJ3IAA4rQG/G+HkFBQnjEQnAIcg");
	this.shape_4.setTransform(232.3,286.9);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_5.setTransform(268.4,309.2);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_6.setTransform(342.3,309.2);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f().s("#CCCCCC").ss(6,1,1).p("ABIABQAAAfgWAXQgVAWgdAAQgdAAgVgWQgVgXAAgfQAAggAVgWQAVgXAdAAQAdAAAVAXQAWAWAAAgg");
	this.shape_7.setTransform(484.5,254.5);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_8.setTransform(342.3,309.2);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#000000").s().p("AgyA3QgVgXAAgfQAAggAVgWQAVgXAdAAQAdAAAVAXQAWAWAAAgQAAAfgWAXQgVAWgdAAQgdAAgVgWg");
	this.shape_9.setTransform(484.5,254.5);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_10.setTransform(342.9,294.7);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f().s("#000000").ss(2,1,1).p("AF3vAQqRHYhRHuQg1FFDFE5QBlCgCmCd");
	this.shape_11.setTransform(422.5,258.9);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_12.setTransform(342.9,290.9);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_13.setTransform(342.9,252.1);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_14.setTransform(342.9,252.1);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_15.setTransform(342.9,252.1);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_16.setTransform(342.9,252.1);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f().s("#000000").ss(2,1,1).p("AF3vAQqRHYhRHuQg1FFDGE5QBlCgClCd");
	this.shape_17.setTransform(422.4,258.9);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f().s("#000000").ss(1.5,1,1).p("");
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_3}]},1).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_6}]},1).to({state:[{t:this.shape_9},{t:this.shape_8},{t:this.shape_7}]},1).to({state:[{t:this.shape_9},{t:this.shape_10},{t:this.shape_7}]},1).to({state:[{t:this.shape_9},{t:this.shape_10},{t:this.shape_7},{t:this.shape_11}]},1).to({state:[{t:this.shape_9},{t:this.shape_12},{t:this.shape_7},{t:this.shape_11}]},1).to({state:[{t:this.shape_9},{t:this.shape_13},{t:this.shape_7},{t:this.shape_11}]},1).to({state:[{t:this.shape_9},{t:this.shape_14},{t:this.shape_7},{t:this.shape_11}]},1).to({state:[{t:this.shape_9},{t:this.shape_15},{t:this.shape_7},{t:this.shape_11}]},1).to({state:[{t:this.shape_9},{t:this.shape_16},{t:this.shape_7},{t:this.shape_11}]},1).to({state:[{t:this.shape_9},{t:this.shape_18},{t:this.shape_7},{t:this.shape_17}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},2).to({state:[{t:this.instance_6}]},4).to({state:[{t:this.instance_7}]},5).to({state:[{t:this.instance_8}]},10).to({state:[{t:this.instance_9}]},5).to({state:[{t:this.instance_9}]},5).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(17).to({_off:false},0).wait(1).to({regY:-0.5,x:343.8,y:252.5,alpha:0.2},0).wait(1).to({alpha:0.4},0).wait(1).to({alpha:0.6},0).wait(1).to({alpha:0.8},0).wait(1).to({alpha:1},0).wait(1).to({regX:292.9,y:252.7},0).wait(2).to({_off:true},4).wait(86));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(49).to({_off:false},0).wait(6).to({regX:-18.5,regY:-6.5,x:350.6,y:233},0).wait(1).to({x:362.1,y:215.2},0).wait(1).to({x:376.8,y:200},0).wait(1).to({x:395.1,y:189.5},0).wait(1).to({x:415.9,y:186.1},0).wait(1).to({x:436.8,y:189.5},0).wait(1).to({x:456.3,y:197.5},0).wait(1).to({x:474.5,y:208.5},0).wait(1).to({x:484.2,y:236.7},0).wait(1).to({x:495.3,y:264.4},0).wait(1).to({x:508.3,y:291.3},0).wait(1).to({x:523.5,y:317},0).wait(1).to({x:541.2,y:341},0).wait(1).to({x:561.9,y:362.6},0).wait(1).to({x:585.7,y:380.5},0).wait(1).to({x:612.5,y:393.7},0).wait(1).to({x:641.3,y:401.3},0).wait(1).to({x:671.1,y:403.4},0).wait(1).to({x:700.8,y:400.6},0).wait(1).to({x:729.8,y:393.8},0).wait(1).to({x:758.1,y:384},0).wait(1).to({x:785.3,y:371.9},0).wait(1).to({x:811.7,y:357.9},0).wait(1).to({x:837.3,y:342.5},0).wait(1).to({x:844.6,y:338.8},0).wait(1).to({x:851.9,y:335.1},0).wait(1).to({x:859.2,y:331.4},0).wait(1).to({x:866.4,y:327.7},0).wait(1).to({x:873.7,y:324},0).wait(1).to({x:881,y:320.3},0).wait(1).to({x:888.3,y:316.6},0).wait(1).to({x:895.5,y:312.9},0).wait(1).to({x:902.8,y:309.2},0).wait(1).to({x:910.1,y:305.5},0).wait(25).to({_off:true},1).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(18).to({_off:false},0).wait(6).to({alpha:0.641},0).wait(5).to({alpha:0.75},0).wait(86));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_19).wait(115));

...
// stage content:
(lib.CCKCC25b = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.fifteen15.addEventListener("click", fl_ClickToGoToAndStopAtFrame_2.bind(this));
	...
	this.frame_1 = function() {
		this.sixteen16.addEventListener("click", fl_ClickToGoToAndStopAtFrame_3.bind(this));
	...
	this.frame_2 = function() {
		this.seventeen17.addEventListener("click", fl_ClickToGoToAndStopAtFrame_4.bind(this));
	...
	this.frame_3 = function() {
		this.eighteen18.addEventListener("click", fl_ClickToGoToAndStopAtFrame_5.bind(this));
	...
	this.frame_4 = function() {
		this.nineteen19.addEventListener("click", fl_ClickToGoToAndStopAtFrame_6.bind(this));
	...
	this.frame_5 = function() {
		this.twenty20.addEventListener("click", fl_ClickToGoToAndStopAtFrame_7.bind(this));
	...
	this.frame_6 = function() {
		this.twentyone21.addEventListener("click", fl_ClickToGoToAndStopAtFrame_8.bind(this));
	...
	this.frame_7 = function() {
		this.twentytwo22.addEventListener("click", fl_ClickToGoToAndStopAtFrame_9.bind(this));
	...
	this.frame_8 = function() {
		this.twentythree23.addEventListener("click", fl_ClickToGoToAndStopAtFrame_10.bind(this));
	...
	this.frame_9 = function() {
		this.twentyfour24.addEventListener("click", fl_ClickToGoToAndStopAtFrame_11.bind(this));
	...
	this.frame_10 = function() {
		this.twentyfive25.addEventListener("click", fl_ClickToGoToAndPlayFromFrame.bind(this));
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(1).call(this.frame_1).wait(1).call(this.frame_2).wait(1).call(this.frame_3).wait(1).call(this.frame_4).wait(1).call(this.frame_5).wait(1).call(this.frame_6).wait(1).call(this.frame_7).wait(1).call(this.frame_8).wait(1).call(this.frame_9).wait(1).call(this.frame_10).wait(43).call(this.frame_53).wait(1));

	// Numbers All
	this.twentyfive25 = new lib.twentyfive25();
	this.twentyfive25.parent = this;
	this.twentyfive25.setTransform(299.5,371.5,1,1,0,0,0,-5.5,-1.6);
	...
	this.twentyfour24.setTransform(144.5,323.6);
	...
	this.twentythree23.setTransform(58.1,395.1);
	...
	this.twentytwo22.setTransform(146.5,267.1);
	...
	this.twentyone21.setTransform(199,174.1);
	...
	this.twenty20.setTransform(353,303.1);
	...
	this.nineteen19.setTransform(342,217.1);
	...
	this.eighteen18.setTransform(464,202.1,1,1,0,0,0,0.5,1);
	...
	this.seventeen17.setTransform(506,143.1);
	...
	this.sixteen16.setTransform(565,230.6,1,1,0,0,0,-8.5,-7.5);
	...
	this.fifteen15.setTransform(588,338,1,1,0,0,0,-3,1.4);
	new cjs.ButtonHelper(this.fifteen15, 0, 1, 2, false, new lib.fifteen15(), 3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.fifteen15},{t:this.sixteen16},{t:this.seventeen17},{t:this.eighteen18},{t:this.nineteen19},{t:this.twenty20},{t:this.twentyone21},{t:this.twentytwo22},{t:this.twentythree23},{t:this.twentyfour24},{t:this.twentyfive25}]}).to({state:[]},12).wait(42));

	// Numbers
	this.sixteen16_1 = new lib.sixteen16();
	this.sixteen16_1.parent = this;
	this.sixteen16_1.setTransform(565,230.6,1,1,0,0,0,-8.5,-7.5);
	...
	this.seventeen17_1.setTransform(506,143.1);
	...
	this.eighteen18_1.setTransform(464,202.1,1,1,0,0,0,0.5,1);
	...
	this.nineteen19_1.setTransform(342,217.1);
	...
	this.twenty20_1.setTransform(353,303.1);
	...
	this.twentyone21_1.setTransform(199,174.1);
	...
	this.twentytwo22_1.setTransform(146.5,267.1);
	...
	this.twentythree23_1.setTransform(58.1,395.1);
	...
	this.twentyfour24_1.setTransform(144.5,323.6);
	...
	this.twentyfive25_1.setTransform(299.5,371.5,1,1,0,0,0,-5.5,-1.6);
	...
	// Train
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,2,1).p("Aj7kBICWAAIHfH+AhfEAIjon9AArECIj+ACIiooFICAAAAF7EAIlQACIkmoDAiqj8IGHH6");
	this.shape.setTransform(562.7,352.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#000000").ss(1,2,1).p("AjlCbIAJAAQF0mcl0nEIgJAAIgDAAAjoCbIADAAAj7DAICWAAIHfH/AArLFIj+ACIiooHICAAAAhfLCIjon+AF7LDIlQACIkmoFAjlrFIAANgAiqDGIGHH6");
	this.shape_1.setTransform(562.7,307.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#000000").ss(0.4,1,1).p("AgDgDIgBAEIgBADIALAA");
	this.shape_2.setTransform(477.5,322.8);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#000000").ss(1,2,1).p("An2v8IA2D3IEEATIBPkKIAqAAIAAhAInZAAIAABAgAmirUIAAFUIDbAAIAAlUgAhtv8ImJAAAAJlPIpyAAIAANbAAJISIAJAAQF1mdl1nEIgJAAgAgMI3ICVAAIHgH/AEaQ7Ij/ACIinoGICAAAACPQ5Ijnn+AJqQ5IlQACIkmoEABEI8IGIH7ApqIRIJzAB");
	this.shape_3.setTransform(538.8,270);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#000000").ss(1,2,1).p("");
	this.shape_4.setTransform(510.9,270);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("#000000").ss(1,2,1).p("");
	this.shape_5.setTransform(449.4,270);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#000000").ss(1,2,1).p("");
	this.shape_6.setTransform(441.4,270);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f().s("#000000").ss(1,2,1).p("");
	this.shape_7.setTransform(322.9,270);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f().s("#000000").ss(1,2,1).p("");
	this.shape_8.setTransform(322.9,270);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f().s("#000000").ss(1,2,1).p("");
	this.shape_9.setTransform(321,270);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f().s("#000000").ss(1,2,1).p("");
	...
	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f().s("#000000").ss(1,2,1).p("");
	...
	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f().s("#000000").ss(1,2,1).p("At7q9IAANCAEFC4ICWAAIHfH/AIsK8IkAACIinoGICAAAAGgK6Ijon+AN8K6IlQACIknoEAFVC9IGJH7");
	this.shape_12.setTransform(511.5,308.3);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f().s("#5D1908").ss(1,2,1).p("AFNloIAALdIC9AAIAArdgAoJl+QCAEIAKH1IJ8AAIAAr9g");
	this.shape_13.setTransform(350.4,213.9);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FF9900").s().p("Au7K1IAA1pId3AAIAAVpgAj/BsIIOAAIAAgtIgYAAIAAo+IngAAIAAI+IgWAAgAE+BrIIPAAIAAgtIgYAAIAAo/InfAAIAAI/IgYAAgAtBBrIIPAAIAAgtIgXAAIAAo/InfAAIAAI/IgZAAg");
	this.shape_14.setTransform(145.8,275.2);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#8C8484").s().p("AhhGxIAAthIAJAAQF1HEl1Gdg");
	this.shape_15.setTransform(549.5,279.7);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#000000").s().p("AkDAhIAAhBIIHAAIAABBg");
	this.shape_16.setTransform(508.1,245.9);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#5D1908").s().p("EAi5AQjIAAhbI5zAAIAAlIIcbAAIAAE1IBHAAIAABugA98P1IAAh2ISEAAIAAB2gAnaPGIAAheIFPAAIAABegEgmnAPGIAAheIFQAAIAABegAjiM9IAAjNIJBAAIAADNgAl9M2IAAhWIBWAAIAABWgEglOAM2IAAhWIBVAAIAABWgAFNBxIAAiKIOcAAIAACKgEgkpgJOIAAhsIfgAAIAABsgAjCvUIAAhOIZoAAIAABOg");
	this.shape_17.setTransform(279.7,261.8);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FF3300").s().p("");
	this.shape_18.setTransform(297.2,242.2);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#333333").s().p("Ak5MHIAAtgIJzAAIAANggAkGAmIIHAAIAAhCIoHAAgAhxiLIAAlUIDZAAIAAFUgAiPoQIg2j2IGHAAIhOEKg");
	this.shape_19.setTransform(508.4,245.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_3},{t:this.shape_2}]},1).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_6}]},1).to({state:[{t:this.shape_7}]},1).to({state:[{t:this.shape_8}]},1).to({state:[{t:this.shape_9}]},1).to({state:[{t:this.shape_10}]},1).to({state:[{t:this.shape_11},{t:this.instance_1},{t:this.instance}]},1).to({state:[{t:this.instance_2}]},2).to({state:[{t:this.instance_2}]},2).to({state:[{t:this.instance_2}]},2).to({state:[{t:this.instance_2}]},2).to({state:[{t:this.instance_2}]},2).to({state:[{t:this.instance_2}]},2).to({state:[{t:this.instance_2}]},2).to({state:[{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3}]},2).wait(27));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(13).to({_off:false},0).wait(2).to({alpha:0.238},0).wait(2).to({alpha:0.352},0).wait(2).to({alpha:0.48},0).wait(2).to({alpha:0.609},0).wait(2).to({alpha:0.672},0).wait(2).to({alpha:0.77},0).to({_off:true},2).wait(27));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(26).to({_off:false},0).wait(28));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_20).wait(54));

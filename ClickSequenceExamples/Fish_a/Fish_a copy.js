...
(lib.fishSwimmingLookingAtYou = function(mode,startPosition,loop) {
	...
	this.shape_105.graphics.f().s("#000000").ss(1.5,1,1).p("");
...
(lib.fish = function(mode,startPosition,loop) {
	...
	// topFins
	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f().s("#000000").ss(1.5,1,1).p("AnLIAIgFgCIufkIIJTJdIgLANIgSAUIpgidIGxF1AgpCrIwNnMIKLL9IAEAFAHjhhIuJqtIGHOxAWahmIgMgLIxEvaIDUPZ");
...
// stage content:
(lib.Fish_a = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		this.five05.addEventListener("click", fl_ClickToGoToAndStopAtFrame_11.bind(this));
	...
	this.frame_1 = function() {
		this.six06.addEventListener("click", fl_ClickToGoToAndStopAtFrame_12.bind(this));
	...
	this.frame_2 = function() {
		this.seven07.addEventListener("click", fl_ClickToGoToAndStopAtFrame_13.bind(this));
	...
	this.frame_3 = function() {
		this.eight08.addEventListener("click", fl_ClickToGoToAndStopAtFrame_14.bind(this));
	...
	this.frame_4 = function() {
		this.nine09.addEventListener("click", fl_ClickToGoToAndStopAtFrame_15.bind(this));
	...
	this.frame_5 = function() {
		this.ten10.addEventListener("click", fl_ClickToGoToAndStopAtFrame_16.bind(this));
	...
	this.frame_6 = function() {
		this.eleven11.addEventListener("click", fl_ClickToGoToAndStopAtFrame_17.bind(this));
	...
	this.frame_7 = function() {
		this.twelve12.addEventListener("click", fl_ClickToGoToAndStopAtFrame_18.bind(this));
	...
	this.frame_8 = function() {
		this.thirteen13.addEventListener("click", fl_ClickToGoToAndStopAtFrame_19.bind(this));
	...
	this.frame_9 = function() {
		this.fourteen14.addEventListener("click", fl_ClickToGoToAndStopAtFrame_20.bind(this));
	...
	this.frame_10 = function() {
		this.fifteen15.addEventListener("click", fl_ClickToGoToAndPlayFromFrame.bind(this));
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(1).call(this.frame_1).wait(1).call(this.frame_2).wait(1).call(this.frame_3).wait(1).call(this.frame_4).wait(1).call(this.frame_5).wait(1).call(this.frame_6).wait(1).call(this.frame_7).wait(1).call(this.frame_8).wait(1).call(this.frame_9).wait(1).call(this.frame_10).wait(102));

	// Numbers All
	this.fifteen15 = new lib.fifteen15();
	this.fifteen15.parent = this;
	this.fifteen15.setTransform(397,179.5);
	...
	this.fourteen14.setTransform(438,117);
	...
	this.thirteen13.setTransform(265.1,120);
	...
	this.twelve12_1.setTransform(285.1,248);
	...
	this.thirteen13_1.setTransform(265.1,120);
	...
	this.fourteen14_1.setTransform(438,117);
	...
	this.fifteen15_1.setTransform(397,179.5);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance,p:{x:570.4,y:180.7}}]},20).to({state:[{t:this.instance,p:{x:568,y:170}}]},3).to({state:[{t:this.instance_1,p:{x:566.5,y:112.4}}]},3).to({state:[{t:this.instance_1,p:{x:562.1,y:88.9}}]},3).to({state:[{t:this.instance_2}]},3).to({state:[{t:this.instance_2}]},3).to({state:[{t:this.instance_2}]},3).to({state:[{t:this.instance_2}]},4).to({state:[{t:this.instance_3,p:{x:556.7,y:-28.8}}]},3).to({state:[{t:this.instance_3,p:{x:556.2,y:-42.9}}]},3).to({state:[{t:this.instance_3,p:{x:556.7,y:-28.8}}]},3).to({state:[{t:this.instance_4}]},3).to({state:[]},3).wait(55));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(32).to({_off:false},0).wait(3).to({x:559.7,y:53.2},0).wait(3).to({x:558.7,y:28.9},0).wait(4).to({x:558.2,y:7.4},0).to({_off:true},3).wait(67));

	// Fish
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1.5,1,1).p("AiDhbQACABACAAQAoATAoAWQBMApBMAyQAFALAGAKQAIAPAIAO");
	this.shape.setTransform(473.8,172.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#000000").ss(1.5,1,1).p("AEkI4IhzgCAkro5QJXRlAAAMQAAABgBAB");
	this.shape_1.setTransform(514.5,234);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#CCCCCC").ss(6,1,1).p("ABIABQAAAfgWAXQgVAWgdAAQgdAAgVgWQgVgXAAgfQAAggAVgWQAVgXAdAAQAdAAAVAXQAWAWAAAgg");
	this.shape_2.setTransform(484.5,254.5);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#000000").ss(1.5,1,1).p("AkXp+QACABACABQAoASAoAWQBMApBMAzQABACABACIAFAIQAFAKAFAKIAKASQBdCwBOCUQAqBOAlBEQFFJkAAAJQAAABgCABAgknsQACAFACAEQADAGADAFABwDhQAACDhiBaQhiBciLAAQiLAAhihcQhihaAAiDQAAiCBihcQBihaCLAAQCLAABiBaQBiBcAACCgAImJ9IhygC");
	this.shape_3.setTransform(488.6,227.1);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#000000").s().p("AgyA3QgVgXAAgfQAAggAVgWQAVgXAdAAQAdAAAVAXQAWAWAAAgQAAAfgWAXQgVAWgdAAQgdAAgVgWg");
	this.shape_4.setTransform(484.5,254.5);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("#000000").ss(1.5,1,1).p("AhdwFQACAAACABQAoATAoAVQBLAqBMAzIABACQACACABADIADAFIADAGIC9FjQAqBOAlBGQEZIQAmBOQAGAMAAACQAAAAgCACQgnAguRH4QhsA7hnAxQipBSibA5ACQt8QACAFADAEACPt9QABABAAAAQABACABACAEqilQAACChiBZQhjBciKAAQiLAAhihcQhihZAAiCQAAiCBihcQBihbCLAAQCKAABjBbQBiBcAACCgALgD2IhygC");
	this.shape_5.setTransform(470,266.2);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_6.setTransform(420.3,294.8);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_7.setTransform(389.9,294.8);
	...
	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_9.setTransform(342.9,294.8);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_10.setTransform(342.9,294.8);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_11.setTransform(342.9,284.6);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f().s("#000000").ss(2,1,1).p("AF3vAQgFAEgFADQqHHVhRHqQhQHrHrHQ");
	this.shape_12.setTransform(422.4,258.9);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_13.setTransform(342.9,252.1);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f().s("#000000").ss(1.5,1,1).p("");
	this.shape_14.setTransform(342.9,252.1);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f().s("#000000").ss(1.5,1,1).p("");
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_1},{t:this.shape}]},1).to({state:[{t:this.shape_4},{t:this.shape_3},{t:this.shape_2}]},1).to({state:[{t:this.shape_4},{t:this.shape_5},{t:this.shape_2}]},1).to({state:[{t:this.shape_4},{t:this.shape_6},{t:this.shape_2}]},1).to({state:[{t:this.shape_4},{t:this.shape_7},{t:this.shape_2}]},1).to({state:[{t:this.shape_4},{t:this.shape_7},{t:this.shape_2},{t:this.shape_8}]},1).to({state:[{t:this.shape_4},{t:this.shape_9},{t:this.shape_2},{t:this.shape_8}]},1).to({state:[{t:this.shape_4},{t:this.shape_10},{t:this.shape_2},{t:this.shape_8}]},1).to({state:[{t:this.shape_4},{t:this.shape_11},{t:this.shape_2},{t:this.shape_8}]},1).to({state:[{t:this.shape_4},{t:this.shape_13},{t:this.shape_2},{t:this.shape_12}]},1).to({state:[{t:this.shape_4},{t:this.shape_14},{t:this.shape_12},{t:this.shape_2}]},1).to({state:[{t:this.shape_4},{t:this.shape_15},{t:this.shape_12},{t:this.shape_2}]},2).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},2).to({state:[{t:this.instance_6}]},4).to({state:[{t:this.instance_7}]},5).to({state:[{t:this.instance_8}]},10).to({state:[{t:this.instance_9}]},5).to({state:[{t:this.instance_9}]},5).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(14).to({_off:false},0).wait(1).to({regY:-0.5,x:343.8,y:252.5,alpha:0.2},0).wait(1).to({alpha:0.4},0).wait(1).to({alpha:0.6},0).wait(1).to({alpha:0.8},0).wait(1).to({alpha:1},0).wait(1).to({regX:292.9,y:252.7},0).wait(2).to({_off:true},4).wait(86));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(46).to({_off:false},0).wait(6).to({regX:-18.5,regY:-6.5,x:349.5,y:235.1},0).wait(1).to({x:359.3,y:219},0).wait(1).to({x:371.5,y:204.6},0).wait(1).to({x:386.5,y:193.4},0).wait(1).to({x:404.2,y:187},0).wait(1).to({x:423,y:186.6},0).wait(1).to({x:441.2,y:190.9},0).wait(1).to({x:458.4,y:198.6},0).wait(1).to({x:474.5,y:208.5},0).wait(1).to({x:483.5,y:235},0).wait(1).to({x:493.9,y:261.2},0).wait(1).to({x:505.9,y:286.6},0).wait(1).to({x:519.7,y:311.1},0).wait(1).to({x:535.7,y:334.2},0).wait(1).to({x:554.2,y:355.3},0).wait(1).to({x:575.5,y:373.6},0).wait(1).to({x:599.6,y:388.1},0).wait(1).to({x:625.9,y:398},0).wait(1).to({x:653.5,y:402.8},0).wait(1).to({x:681.6,y:402.9},0).wait(1).to({x:709.4,y:399},0).wait(1).to({x:736.6,y:391.8},0).wait(1).to({x:763,y:382},0).wait(1).to({x:788.5,y:370.3},0).wait(1).to({x:813.3,y:357.1},0).wait(1).to({x:837.3,y:342.5},0).wait(1).to({x:844,y:339.1},0).wait(1).to({x:850.6,y:335.8},0).wait(1).to({x:857.2,y:332.4},0).wait(1).to({x:863.8,y:329},0).wait(1).to({x:870.4,y:325.7},0).wait(1).to({x:877,y:322.3},0).wait(1).to({x:883.6,y:318.9},0).wait(1).to({x:890.2,y:315.6},0).wait(1).to({x:896.9,y:312.2},0).wait(1).to({x:903.5,y:308.8},0).wait(1).to({x:910.1,y:305.5},0).wait(1).to({x:916.7,y:302.1},0).wait(1).to({x:923.3,y:298.8},0).wait(1).to({x:929.9,y:295.4},0).wait(1).to({x:936.5,y:292},0).wait(1).to({x:943.2,y:288.7},0).wait(1).to({x:949.8,y:285.3},0).wait(1).to({x:956.4,y:281.9},0).wait(1).to({x:963,y:278.6},0).wait(1).to({x:969.6,y:275.2},0).wait(1).to({x:976.2,y:271.8},0).wait(1).to({x:982.8,y:268.5},0).wait(1).to({x:989.4,y:265.1},0).wait(12));
	...
	// Border
	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f().s("#000000").ss(1,1,1).p("Egx/glfMBj/AAAMAAABK/Mhj/AAAg");
	this.shape_16.setTransform(320,240);
	...
	this.instance_11.setTransform(320.4,240);
	this.instance_11.alpha = 0.41;
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(18).to({_off:false},0).wait(5).to({alpha:0.641},0).wait(5).to({alpha:0.75},0).wait(84));
